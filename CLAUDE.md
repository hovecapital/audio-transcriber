...
IMPORTANT: Less code is better. These rules are designed to enforce clarity, maintainability, and type safety without overcomplicating the codebase. Always prioritize simplicity and readability.

IMPORTANT: comments are to be used rarely, the code should be self documenting where possible.
...
IMPORTANT: use context7 mcp to read the documentation for libraries used.
